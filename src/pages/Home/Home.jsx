    ...
    <main className="home">
      <div className="home__landing">
        ...
        <div className="home__landing-inner">
          <h1>Boost Efficiency. Cut Costs. Grow Smarter with AI.</h1>
        ...
        <div className="section__1-inner">
          ...
          <ul>
            <li>
              ...
              efficiency in Canada.  <a target="_blank"  href="https://www150.statcan.gc.ca/n1/pub/11-621-m/11-621-m2024008-eng.htm">(Statistics Canada)</a>
            </li>
            <li>
              41% of small businesses have used AI to free up their time for
              higher-value work.  <a target="_blank"  href="https://www.forbes.com/councils/forbesbusinesscouncil/2024/07/24/ais-transformative-impact-on-small-businesses/">(Forbes)</a>
            </li>
            <li>
              37% reinvest AI-driven cost savings into new technologies for
              growth.  <a target="_blank" href="https://theluxuryplaybook.com/100-interesting-stats-about-ai-in-small-businesses-2025-updated/#:~:text=AI%20tools%20for%20financial%20management,automating%20accounting%20and%20bookkeeping%20tasks">(The Luxury playbook)</a>
            </li>
          </ul>
          <i>
      ...
      <div className="section__3-inner">
        ...
        <ul>
          ...
          <li>
            Competitive advantage – Keep prices stable and invest in the future.
          </li>
        </ul>
        <i>
          AI isn’t just for big corporations—it’s the key to your small business
          success.
        </i>
      </div>
      </div>
